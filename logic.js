...
//--------------Listeners-----------------------
bill_in.addEventListener('focus', (e) => {bill_in.value = ''; bill = 0;});
...
people_in.addEventListener('focus', (e) => {people_in.value = ''; many= 0;});
...
for(let b_perc of b_percent){    
    if(b_perc.id !== "custom"  ){
        ...
        b_perc.addEventListener('focus', (e) => {b_perc.value = ''; percent = 0 ;});
